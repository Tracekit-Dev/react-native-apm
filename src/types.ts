...
// ============================================================================
// Snapshot Types (Code Monitoring)
// ============================================================================
...
export interface BeforeSendCallback {
...
export interface TracekitClient {
  ...
  // Snapshot/Code Monitoring operations
  captureSnapshot(
    name: string, 
    data: Record<string, unknown>
  ): Promise<void>;
