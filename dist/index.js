...
__export(index_exports, {
  ...
  OfflineAwareTransport: () => OfflineAwareTransport,
  PerformanceProfiler: () => PerformanceProfiler,
  ScreenTracker: () => ScreenTracker,
  StorageKeys: () => StorageKeys,
  StorageManager: () => StorageManager,
  TracekitClient: () => TracekitClient,
  TracekitErrorBoundary: () => TracekitErrorBoundary,
  TracekitProvider: () => TracekitProvider,
  ...
  uninstallNetworkInterceptor: () => uninstallNetworkInterceptor,
  useAsyncTracking: () => useAsyncTracking,
  useErrorBoundary: () => useErrorBoundary,
  usePerformanceTracking: () => usePerformanceTracking,
  useScreenTracking: () => useScreenTracking,
  useSpan: () => useSpan,
  useTouchTracking: () => useTouchTracking,
  useTracekit: () => useTracekit,
  useTracekitContext: () => useTracekitContext,
  useUser: () => useUser,
  withTracekit: () => withTracekit
});
...
function setStorageManager(manager) {
...
var TracekitContext = (0, import_react.createContext)(null);
function useTracekitContext() {
  const context = (0, import_react.useContext)(TracekitContext);
  if (!context) {
...
function TracekitProvider({
  ...
  const value = (0, import_react.useMemo)(
    () => ({
      client: client2,
      isInitialized: client2.isInitialized()
    }),
    [client2]
  );
  return /* @__PURE__ */ import_react.default.createElement(TracekitContext.Provider, { value }, children);
}
var TracekitErrorBoundary = class extends import_react.Component {
  constructor(props) {
    super(props);
    this.resetError = () => {
  ...
  componentDidCatch(error, errorInfo) {
    ...
    client2.captureException(error, {
...
function DefaultErrorFallback({
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_react_native4.View, { style: styles.container }, /* @__PURE__ */ import_react.default.createElement(import_react_native4.Text, { style: styles.title }, "Something went wrong"), /* @__PURE__ */ import_react.default.createElement(import_react_native4.Text, { style: styles.message }, "We're sorry, but something unexpected happened."), showDetails && __DEV__ && /* @__PURE__ */ import_react.default.createElement(import_react_native4.View, { style: styles.detailsContainer }, /* @__PURE__ */ import_react.default.createElement(import_react_native4.Text, { style: styles.errorName }, error.name), /* @__PURE__ */ import_react.default.createElement(import_react_native4.Text, { style: styles.errorMessage }, error.message), error.stack && /* @__PURE__ */ import_react.default.createElement(import_react_native4.Text, { style: styles.errorStack, numberOfLines: 10 }, error.stack)), /* @__PURE__ */ import_react.default.createElement(import_react_native4.TouchableOpacity, { style: styles.button, onPress: resetError }, /* @__PURE__ */ import_react.default.createElement(import_react_native4.Text, { style: styles.buttonText }, "Try Again")));
}
...
function withTracekit(WrappedComponent) {
  return function WithTracekitComponent(props) {
    const { client: client2 } = useTracekitContext();
    return /* @__PURE__ */ import_react.default.createElement(WrappedComponent, { ...props, tracekit: client2 });
  };
}
function ScreenTracker({
  ...
  const client2 = getClient();
  (0, import_react.useEffect)(() => {
    client2.trackScreen(screenName, params);
  }, [client2, screenName, params]);
...
function PerformanceProfiler({
  ...
  const handleRender = (profileId, phase, actualDuration, baseDuration, startTime, commitTime) => {
    const span = client2.startSpan(`render.${profileId}`, null, {
      "render.id": profileId,
      "render.phase": phase,
      "render.actual_duration": actualDuration,
      "render.base_duration": baseDuration
    });
    client2.endSpan(span);
    onRender?.({
      id: profileId,
      phase,
      actualDuration,
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_react.default.Profiler, { id, onRender: handleRender }, children);
}
...
function useTracekit() {
  const client2 = getClient();
  const captureException2 = (0, import_react2.useCallback)(
    (error, context) => {
      return client2.captureException(error, context);
    },
    [client2]
  );
  const captureMessage2 = (0, import_react2.useCallback)(
    (message, level, context) => {
      return client2.captureMessage(message, level, context);
    },
    [client2]
  );
  const captureSnapshot2 = (0, import_react2.useCallback)(
    async (name, data) => {
      return client2.captureSnapshot(name, data);
    },
    [client2]
  );
  const setUser2 = (0, import_react2.useCallback)(
    (user) => {
      client2.setUser(user);
    },
    [client2]
  ...
  const setTag2 = (0, import_react2.useCallback)(
    (key, value) => {
      client2.setTag(key, value);
    },
    [client2]
  );
  const setContext2 = (0, import_react2.useCallback)(
    (name, context) => {
      client2.setContext(name, context);
    },
    [client2]
  );
  return {
...
function useSpan(name, options) {
  const client2 = getClient();
  const spanRef = (0, import_react2.useRef)(null);
  ...
  const start = (0, import_react2.useCallback)(() => {
    ...
    spanRef.current = client2.startSpan(
      name,
      options?.parentSpan,
      options?.attributes
    );
    setIsActive(true);
    return spanRef.current;
  }, [client2, name, options?.parentSpan, options?.attributes]);
  const end = (0, import_react2.useCallback)(
    (attributes, status) => {
      if (!spanRef.current) {
        console.warn("No span to end");
        return;
      }
      client2.endSpan(spanRef.current, attributes, status);
  ...
  const setAttributes = (0, import_react2.useCallback)(
    (attributes) => {
      if (!spanRef.current) {
        console.warn("No active span");
        return;
...
function useScreenTracking(screenName, params) {
  const client2 = getClient();
  const tracked = (0, import_react2.useRef)(false);
  (0, import_react2.useEffect)(() => {
    if (!tracked.current) {
      client2.trackScreen(screenName, params);
...
function usePerformanceTracking(componentName) {
  const client2 = getClient();
  const renderCount = (0, import_react2.useRef)(0);
  const firstRenderTime = (0, import_react2.useRef)(null);
  (0, import_react2.useEffect)(() => {
    renderCount.current += 1;
    if (firstRenderTime.current === null) {
      firstRenderTime.current = Date.now();
    }
    const span = client2.startSpan(`component.render.${componentName}`, null, {
...
function useAsyncTracking(operationName, asyncFn, options) {
  ...
  const execute = (0, import_react2.useCallback)(async () => {
    setLoading(true);
    setError(null);
    const span = client2.startSpan(operationName, null, options?.attributes);
    try {
      const result = await asyncFn();
      setData(result);
      client2.endSpan(span, { "operation.success": true });
      return result;
    } catch (err) {
      const error2 = err instanceof Error ? err : new Error(String(err));
      setError(error2);
      client2.endSpan(span, { "operation.success": false }, "ERROR");
      client2.captureException(error2, { operation: operationName });
      throw error2;
    } finally {
      setLoading(false);
    }
  }, [client2, operationName, asyncFn, options?.attributes]);
  (0, import_react2.useEffect)(() => {
...
function useErrorBoundary() {
  const client2 = getClient();
  const [error, setError] = (0, import_react2.useState)(null);
  const resetError = (0, import_react2.useCallback)(() => {
    setError(null);
  }, []);
...
function useTouchTracking(elementName) {
  const client2 = getClient();
  const trackPress = (0, import_react2.useCallback)(() => {
  ...
  const trackLongPress = (0, import_react2.useCallback)(() => {
    client2.addBreadcrumb({
      type: "ui",
      category: "touch",
...
function useUser() {
  const client2 = getClient();
  const [user, setUserState] = (0, import_react2.useState)(client2.getUser());
  const setUser2 = (0, import_react2.useCallback)(
    (newUser) => {
      client2.setUser(newUser);
